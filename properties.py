...
class BatchExportSettings(PropertyGroup):
    ...
    copy_on_export: BoolProperty(
        name="Make Copies", description="Make a copy of exported files in a secondary directory"
    )
    ...
    mode: EnumProperty(
        ...
        items=[
            ...
            (
                ...
                "Objects are exported inside sub-directories according to their parent collection",
                4,
            ),
            (
                "COLLECTION_SUBDIR_PARENTS",
                "Collection Sub-Directories By Parent",
                "Same as 'Collection Sub-directories', objects that are\nparents have their children exported along with them",
                5,
            ),
            (
                "SCENE",
                "Scene",
                "Export the scene into one file\nUse prefix or suffix for filename, else .blend file name is used.",
                6,
            ),
        ],
    ...
    usd_format: EnumProperty(
        ...
        items=[
            (
                ".usd",
                "Plain (.usd)",
                "Can be either binary or ASCII\nIn Blender this exports to binary",
                1,
            ),
